 ...
 * @LastEditTime: 2022-01-05 10:48:06
 * @LastEditors: Gavin
 */


export const HOME_TITLE = 'Artemis Admin' // index title
export const SETTINGS_IS_SHOW = true // tabViews
export const SETTINGS_MENU = '#304156' // themeMenu
export const SETTINGS_TABVIEW = '#1890ff' // themeTabview
